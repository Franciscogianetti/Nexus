  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-10 py-12 flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
        ...
        <h1 className="text-4xl font-black tracking-tight md:text-5xl">Encontre o seu tamanho ideal</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-brand-navy">Dimensões do Produto</h3>
            <span className="text-xs font-medium bg-gray-100 px-3 py-1 rounded text-gray-500">Medidas em cm</span>
          </div>
          ...
          <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm bg-white">
            <div className="overflow-x-auto">
              <table className="w-full min-w-[600px] text-left text-sm">
                ...
                <tbody className="divide-y divide-gray-100">
                  {SIZES.map(s => (
                    <tr key={s.size} className="hover:bg-primary/5 transition-colors group cursor-default">
                      <td className="px-6 py-4 font-bold text-lg text-brand-navy group-hover:text-primary">{s.size}</td>
                      <td className="px-6 py-4 text-center font-medium">{s.width}</td>
                      <td className="px-6 py-4 text-center font-medium">{s.height}</td>
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 text-xs text-gray-400 flex items-center gap-2">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <h3 className="text-xl font-bold text-brand-navy">Como Medir Corretamente</h3>
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm flex flex-col gap-8">
            <div className="relative w-full aspect-[4/3] bg-gray-50 rounded-xl overflow-hidden flex items-center justify-center border border-gray-100">
              <div className="relative w-40 h-48 border-2 border-gray-300 rounded-t-3xl border-b-0 mx-auto mt-6">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-6 border-2 border-gray-300 rounded-full bg-white z-10"></div>
                <div className="absolute top-0 -left-8 w-8 h-24 border-2 border-gray-300 -skew-x-12 origin-top-right border-r-0 rounded-l-lg"></div>
                <div className="absolute top-0 -right-8 w-8 h-24 border-2 border-gray-300 skew-x-12 origin-top-left border-l-0 rounded-r-lg"></div>
                <div className="absolute top-0 left-0 w-full h-full border-b-2 border-gray-300 bg-white z-0"></div>
                ...
                <div className="absolute top-20 left-0 w-full flex items-center justify-center gap-1">
                  ...
                  <span className="text-[8px] font-bold text-primary bg-white px-1">LARGURA</span>
                  <div className="h-[1px] flex-1 bg-primary"></div>
                </div>
                <div className="absolute top-0 left-1/2 h-full flex flex-col items-center justify-center gap-1 -ml-[0.5px]">
                  <div className="w-[1px] flex-1 bg-primary"></div>
                  <span className="text-[8px] font-bold text-primary bg-white py-1 rotate-90">ALTURA</span>
                  <div className="w-[1px] flex-1 bg-primary"></div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={step.n} className="flex gap-4 items-start">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary font-bold text-sm">{step.n}</div>
                  <div>
                    <h4 className="font-bold text-brand-navy text-sm">{step.t}</h4>
      ...
      <section className="mt-10">
        <h3 className="text-2xl font-bold text-brand-navy mb-8">Referência de Caimento</h3>

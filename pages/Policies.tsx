...
const Policies: React.FC = () => {
    return (
        <div className="max-w-[800px] mx-auto px-4 py-20 flex flex-col gap-12">
            <section>
                <h1 className="text-4xl font-black text-brand-navy mb-6 tracking-tight">Políticas da Urban Tide</h1>
            ...
            <section className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
                <div className="flex items-center gap-3 text-brand-gold mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-brand-navy">Política de Trocas</h2>
                </div>
                <div className="space-y-4 text-gray-600 leading-relaxed">
                    <p>
                        Oferecemos a <strong>primeira troca grátis</strong> em até 7 dias após o recebimento do produto, caso o tamanho não tenha ficado ideal ou você deseje outro modelo.
                    </p>
                    <ul className="list-disc pl-6 space-y-2">
                        <li>O produto deve estar com as etiquetas originais fixadas.</li>
                        <li>Não pode apresentar sinais de uso ou lavagem.</li>
                        <li>A solicitação deve ser feita via WhatsApp com o número do seu pedido.</li>
                    </ul>
                </div>
            </section>
            ...
            <section className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
                <div className="flex items-center gap-3 text-brand-gold mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-brand-navy">Prazos de Entrega</h2>
                </div>
                <div className="space-y-4 text-gray-600 leading-relaxed">
                    <p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                        <div className="p-4 bg-gray-50 rounded-xl">
                            <h4 className="font-bold text-brand-navy mb-1">Sudeste</h4>
                            <p className="text-sm">2 a 5 dias úteis</p>
                        </div>
                        <div className="p-4 bg-gray-50 rounded-xl">
                            <h4 className="font-bold text-brand-navy mb-1">Sul e Centro-Oeste</h4>
                            <p className="text-sm">4 a 8 dias úteis</p>
                        </div>
                        <div className="p-4 bg-gray-50 rounded-xl">
                            <h4 className="font-bold text-brand-navy mb-1">Norte e Nordeste</h4>
